...
export default function AuthLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[var(--color-background)]">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[500px] rounded-full blur-[140px] opacity-[0.07] bg-[var(--color-accent)]" />
      <div className="absolute bottom-0 right-1/4 w-[500px] h-[400px] rounded-full blur-[120px] opacity-[0.04] bg-[var(--color-accent-blue)]" />
      <div className="absolute top-1/3 left-1/4 w-[300px] h-[300px] rounded-full blur-[100px] opacity-[0.03] bg-[var(--color-success)]" />
      ...
      <div className="relative w-full max-w-md px-6">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[var(--color-card)] border border-[var(--color-border)] mb-6 shadow-xl shadow-black/20 relative overflow-hidden">
            {/* Inner gold glow */}
